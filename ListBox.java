//write a program using selenium web driver, 
//count number of items from list box in test automation practice application and 
//print items listed in drop down box, and use testng framework
package com.ListBoxItem;
	 ...
	 public void DropDownList() throws Exception {
		 WebElement Country_Dropdown = driver.findElement(By.id("country"));
		  ...
		  for(WebElement ele : c_list) {
			  ...
			  System.out.println("Country name in list : "+ coun_name);
		  }
